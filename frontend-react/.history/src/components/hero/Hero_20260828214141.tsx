...
export function Hero({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative mx-auto grid w-full max-w-6xl flex-1 grid-cols-1 items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
        <motion.div
        ...
        <div
          aria-hidden
          className="relative hidden h-[420px] rounded-3xl border border-line lg:block"
        >
          <LivingSwarmField
            anchors={[
              { id: "a", x: 140, y: 110, energy: 0.85, intensity: 0.5, color: "gold" },
              { id: "b", x: 300, y: 220, energy: 0.5, intensity: 1, color: "violet" },
              { id: "c", x: 90, y: 300, energy: 0.3, intensity: 0.7, color: "violet" },
            ]}
            active
            particleCount={140}
