...
export function TaskForm({
  ...
  return (
    <div className="relative">
      <div
        aria-hidden
        className="pointer-events-none absolute -inset-6 rounded-[36px] bg-gold/[0.12] blur-2xl"
      />
      <div className="relative rounded-[29px] bg-gradient-to-br from-gold/50 via-violet/30 to-transparent p-[1.5px] shadow-[0_0_70px_-20px_rgba(217,164,65,0.45)]">
        <motion.form
          ref={panelRef}
